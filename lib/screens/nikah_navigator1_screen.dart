...
import 'nikah_navigator2_screen.dart';

class NikahNavigator1Screen extends StatelessWidget {
  const NikahNavigator1Screen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // 3 Images
              Image.asset('assets/images/card21.png'),
              const SizedBox(height: 10),
              Image.asset('assets/images/card22.png'),
              const SizedBox(height: 10),
              Image.asset('assets/images/card23.png'),
              ...
              // 2 Images for Search History
              Image.asset('assets/images/card24.png'),
              const SizedBox(height: 10),
              Image.asset('assets/images/card25.png'),

              const SizedBox(height: 20),

              // New Heading above Grid
              const Text(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const NikahNavigator2Screen()),
            );
          },
          child: Row(
