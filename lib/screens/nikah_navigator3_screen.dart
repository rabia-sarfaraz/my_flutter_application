...
import 'nikah_navigator4_screen.dart';

class NikahNavigator3Screen extends StatelessWidget {
  const NikahNavigator3Screen({super.key});
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const NikahNavigator4Screen(),
              ),
            );
          },
          child: Row(
